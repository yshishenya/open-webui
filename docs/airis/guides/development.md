...
- Pick the appropriate workflow from `.memory_bank/workflows/` (new feature / bugfix / refactor / code review).
...
- Non-trivial work: create a work item spec under `.memory_bank/specs/work_items/`.
- On feature branches: log status in `.memory_bank/branch_updates/` and consolidate on integration branch (see `.memory_bank/guides/task_updates.md`).
