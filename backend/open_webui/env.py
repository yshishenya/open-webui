...
ENABLE_PUBLIC_ACTIVE_USERS_COUNT = os.getenv('ENABLE_PUBLIC_ACTIVE_USERS_COUNT', 'False').lower() == 'true'
...
# but is scoped to Airis to avoid interfering with system-level settings.
...
def _parse_ssl_env(value: str) -> 'bool | _ssl.SSLContext':
    ...
    This allows users with corporate or internal CAs to point Airis
...
# Useful when Airis sits behind a reverse proxy / API gateway that
...
# compatible APIs for endpoints not natively handled by Airis.
...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Airis')
if WEBUI_NAME != 'Airis':
    WEBUI_NAME += ' (Airis)'

WEBUI_FAVICON_URL = 'https://airis.you/static/favicon.png'
...
ENABLE_BILLING_WALLET = os.getenv('ENABLE_BILLING_WALLET', 'False').lower() == 'true'
ENABLE_BILLING_SUBSCRIPTIONS = os.getenv('ENABLE_BILLING_SUBSCRIPTIONS', 'False').lower() == 'true'
BILLING_DEFAULT_CURRENCY = os.getenv('BILLING_DEFAULT_CURRENCY', 'RUB')
BILLING_RATE_CARD_VERSION = os.getenv('BILLING_RATE_CARD_VERSION', '2025-01')
...
BILLING_RECEIPT_PAYMENT_SUBJECT = os.getenv('BILLING_RECEIPT_PAYMENT_SUBJECT', 'service').strip() or 'service'
BILLING_RECEIPT_TAX_SYSTEM_CODE = _parse_optional_int(os.getenv('BILLING_RECEIPT_TAX_SYSTEM_CODE', ''))

PUBLIC_PRICING_POPULAR_MODELS = _parse_str_list(os.getenv('PUBLIC_PRICING_POPULAR_MODELS', ''))
PUBLIC_PRICING_RECOMMENDED_TEXT_MODEL = os.getenv('PUBLIC_PRICING_RECOMMENDED_TEXT_MODEL', '')
PUBLIC_PRICING_RECOMMENDED_IMAGE_MODEL = os.getenv('PUBLIC_PRICING_RECOMMENDED_IMAGE_MODEL', '')
PUBLIC_PRICING_RECOMMENDED_AUDIO_MODEL = os.getenv('PUBLIC_PRICING_RECOMMENDED_AUDIO_MODEL', '')
PUBLIC_PRICING_RATE_CARD_MODEL_LIMIT = int(os.getenv('PUBLIC_PRICING_RATE_CARD_MODEL_LIMIT', '50'))
...
YOOKASSA_WEBHOOK_ENFORCE_SIGNATURE = os.getenv('YOOKASSA_WEBHOOK_ENFORCE_SIGNATURE', 'False').lower() == 'true'
YOOKASSA_WEBHOOK_ENFORCE_IP_ALLOWLIST = os.getenv('YOOKASSA_WEBHOOK_ENFORCE_IP_ALLOWLIST', 'False').lower() == 'true'
YOOKASSA_WEBHOOK_TRUST_X_FORWARDED_FOR = os.getenv('YOOKASSA_WEBHOOK_TRUST_X_FORWARDED_FOR', 'False').lower() == 'true'
YOOKASSA_WEBHOOK_ALLOWED_IP_RANGES = os.getenv('YOOKASSA_WEBHOOK_ALLOWED_IP_RANGES', '')
