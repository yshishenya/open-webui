...
telegram_state_rate_limiter = RateLimiter(redis_client=get_redis_client(), limit=60, window=60 * 10)
telegram_action_rate_limiter = RateLimiter(redis_client=get_redis_client(), limit=5 * 3, window=60 * 3)
