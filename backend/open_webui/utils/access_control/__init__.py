...
async def has_permission(
    ...
    effective_defaults = json.loads(json.dumps(default_permissions or {}))
    effective_defaults = fill_missing_permissions(effective_defaults, DEFAULT_USER_PERMISSIONS)
    return get_permission(effective_defaults, permission_hierarchy)
