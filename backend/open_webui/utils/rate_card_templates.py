...
DEFAULT_RATE_CARD_TEMPLATES: List[RateCardTemplate] = [
    ...
    },
    {
        ...
        "unit": "image_1024",
        "raw_cost_per_unit_kopeks": 0,
        "platform_factor": 1.60,
        "fixed_fee_kopeks": 0,
        "min_charge_kopeks": 500,
    },
    {
        "modality": "tts",
        "unit": "tts_char",
        "raw_cost_per_unit_kopeks": 0,
        "platform_factor": 1.25,
        "fixed_fee_kopeks": 0,
        "min_charge_kopeks": 10,
    },
]
        ...
        entries.append(
            {
                ...
                "platform_factor": float(template.get("platform_factor", 1)),
                "fixed_fee_kopeks": int(template.get("fixed_fee_kopeks", 0)),
                "min_charge_kopeks": int(template.get("min_charge_kopeks", 0)),
