...
- Fork-owned (safe to change freely): `.memory_bank/**`, `.codex/**`, new `src/lib/utils/airis/**` modules, and other clearly Airis-specific additions.
...
- Create a work item spec: `.memory_bank/specs/work_items/YYYY-MM-DD__<type>__<slug>.md`
...
5. Record a short entry in `.memory_bank/current_tasks.md` describing the sync and any high-risk conflict resolutions.
