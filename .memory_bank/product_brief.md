...
## Project Name
**Airis** - Private Fork of Open WebUI

## Project Goal
A full-featured web interface for interacting with Large Language Models (LLMs) with integrated billing, quota management, and multi-provider AI support. Airis enables users to chat with AI models, manage knowledge bases, create custom tools and functions, and collaborate in real-time.
...
### Plan Structure
- **Free Tier**: Limited requests, basic models only
- **Starter**: Low quotas, suitable for individuals
- **Professional**: Medium quotas, all models
- **Business**: High quotas, priority support
- **Enterprise**: Custom quotas, dedicated support
