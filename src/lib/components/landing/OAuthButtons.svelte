...
<div class="bg-white/90 rounded-2xl border border-gray-200/70 shadow-sm p-8 md:p-10">
	<h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-6">Войти или создать аккаунт</h2>
	...
	<div class="space-y-4 max-w-md">
		...
		>
			<svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
				<path
					d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm4.5 18.75h-2.437v-6.891h-1.126c-1.863 0-2.924-1.021-2.924-2.799 0-1.828 1.061-2.81 2.924-2.81h3.563v2.156h-3.188c-.626 0-.938.313-.938.938 0 .625.312.937.938.937h1.751v8.469h1.437z"
				/>
			</svg>
			Войти через Яндекс
		</button>
		...
		<div class="pt-4 border-t border-gray-200/70 text-sm text-gray-600">
			<a href="/auth" class="font-medium text-gray-700 hover:text-gray-900 transition-colors">
