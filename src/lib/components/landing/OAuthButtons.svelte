...
<div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
	...
	<div class="space-y-4 max-w-md mx-auto">
		...
		<button
			...
			class="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#0077FF] hover:bg-[#0066DD] text-white rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
		>
		...
		<button
			...
			class="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#FC3F1D] hover:bg-[#E63600] text-white rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
		>
			<svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
