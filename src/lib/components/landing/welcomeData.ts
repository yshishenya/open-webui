...
const exampleTabsBase: ExampleTab[] = [
	{
		...
		cards: [
			...
			},
			{
				...
				preset: 'ad_copy',
				prompt:
					'Сделай объявление или вакансию: {позиция/условия/требования}. Пиши ясно, без воды.'
			},
			{
	...
	},
	{
		...
		cards: [
			...
			},
			{
				...
				prompt:
					'Предложи 4 концепта логотипа для: {бренд}. Опиши стиль и форму. Формат: квадрат.'
			},
			{
				...
				prompt:
					'Создай стикер/персонажа: {описание}. Дай 3 варианта позы/эмоций.'
			},
			{
				title: 'Фон/паттерн',
				...
				prompt:
					'Сделай фон или паттерн. Тема: {тема}. Стиль: {стиль}. Формат: бесшовный.'
			}
		]
	},
	{
		...
		cards: [
			{
				...
				prompt:
					'Объясни тему простыми словами: {тема}. Добавь пример и короткое резюме.'
			},
			{
				...
				prompt:
					'Сделай конспект из текста: {текст}. Выдели ключевые тезисы и термины.'
			},
			{
			...
			},
			{
				...
				preset: 'report_plan',
				prompt:
					'Составь план реферата/доклада по теме: {тема}. Укажи разделы и тезисы.'
			},
			{
	...
	},
	{
		...
		cards: [
			...
			},
			{
				...
				prompt:
					'Сделай сводку встречи из расшифровки: {текст}. Выдели решения и задачи.'
			},
			{
...
export const steps: Step[] = [
	...
	},
	{
		...
		description:
			'Уточняйте стиль, тон, длину. Можно «сделай проще/официальнее/короче».'
	},
	{
		title: 'Доведите до финала',
		description:
			'Попросите улучшить, сократить, добавить структуру — пока не будет идеально.'
	}
];
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				prompt:
					'Сделай короткий отчёт/сводку по тексту: {текст}. Выдели главное и выводы.'
			}
		],
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				preset: 'brief_script',
				prompt:
					'Сделай бриф или сценарий по теме: {тема}. Укажи цель, аудиторию и структуру.'
			}
		],
