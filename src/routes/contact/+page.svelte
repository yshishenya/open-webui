...
<PublicPageLayout
	...
	heroSubtitle="Ответим на вопросы, поможем с настройкой и подберем подходящий тариф"
	heroEyebrow="Контакты"
	heroImage={heroImage}
	heroImageAlt="Команда поддержки AIris"
>
		...
		<div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
			...
			<div class="space-y-6">
				<div class="bg-white rounded-2xl border border-gray-200/70 p-6 shadow-sm">
					...
					<a href="mailto:support@openwebui.ru" class="text-gray-900 font-medium hover:underline">
				...
				<div class="bg-white rounded-2xl border border-gray-200/70 p-6 shadow-sm">
					...
					<div class="flex gap-4">
						<a href="#" class="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center hover:bg-gray-200 transition-colors">
