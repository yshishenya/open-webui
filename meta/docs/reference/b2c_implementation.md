...
- Airis fork docs: `meta/docs/README.md`
- Memory Bank (source of truth): `meta/memory_bank/README.md`
...
- `YANDEX_CLIENT_ID`, `YANDEX_CLIENT_SECRET`, `YANDEX_REDIRECT_URI`, `YANDEX_OAUTH_SCOPE`
...
Note: for Yandex, `YANDEX_REDIRECT_URI` must match the Callback URI configured in the Yandex OAuth app **exactly**.
