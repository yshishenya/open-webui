...
- Spec validation reports generated by `meta/tools/sdd validate`
...
### Generated by `meta/tools/sdd validate`

When you run validation commands, reports are automatically saved here:

```bash
# Validation reports are generated by the SDD CLI wrapper
meta/tools/sdd validate <spec-file>
```
...
find meta/sdd/specs/.reports -name "*.md" -mtime +30 -delete
```
...
- **meta/tools/sdd validate** - Validates spec files and generates reports
