...
- Separates implementation verification from spec reviews (`meta/tools/sdd review`)

## Usage

### Generated by `meta/tools/sdd fidelity-review`
...
meta/tools/sdd fidelity-review <spec-id> --task <task-id>
# Output: meta/sdd/specs/.fidelity-reviews/<spec-id>-task-<task-id>-fidelity-review.json

# Phase-level fidelity review
meta/tools/sdd fidelity-review <spec-id> --phase <phase-id>
# Output: meta/sdd/specs/.fidelity-reviews/<spec-id>-phase-<phase-id>-fidelity-review.json
```
...
- **Minor Deviation** (⚠️) - Small differences with no functional impact
...
find meta/sdd/specs/.fidelity-reviews \( -name "*.md" -o -name "*.json" \) -mtime +30 -delete
```
...
```
meta/sdd/specs/.fidelity-reviews/
├── README.md                                           # This file
├── <spec-id>-task-<task-id>-fidelity-review.json       # Task-level review
├── <spec-id>-phase-<phase-id>-fidelity-review.json     # Phase-level review
└── <spec-id>-fidelity-review-<timestamp>.json          # Historical versions
```
...
- **meta/tools/sdd fidelity-review** - Verifies implementation matches specification
...
**Fidelity Review** (`meta/tools/sdd fidelity-review`):
