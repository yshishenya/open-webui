...
- Remove POST /api/v1/billing/subscription/free and ActivateFreePlanRequest.
...
- Remove free plan references from meta/docs/guides/billing_setup.md and b2c_monetization_plan.
- Log task update per meta/memory_bank/guides/task_updates.md to link this plan.
