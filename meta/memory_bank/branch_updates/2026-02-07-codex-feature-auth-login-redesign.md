...
- [ ] **[UI][AUTH]** Auth page redesign (login screen)
  ...
  - Update: 2026-02-08
  - Update Summary: Stabilize initial panel selection when backend config is late-loaded (keep provider-first default; still default to email panel when no social providers). Tidy closeAuth implementation and guard against navigating to /auth itself.
