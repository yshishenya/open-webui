...
- [x] **[BUG][CI]** Stabilize PR gates: lint, migration-check, and base-policy rechecks
  ...
  - Branch: `codex/ci-remote-run-2026-02-16`
  - Done: 2026-02-16
  - Summary: Added base-branch edit trigger for branch policy, fixed Alembic config/env, made migration-check validate latest-step reversibility (`head -> -1 -> head`), and switched lint gates to incremental changed-file checks.
