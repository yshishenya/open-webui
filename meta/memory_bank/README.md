...
kit-version: 0.1.0
template: scaffolds/memory_bank/README.md.tmpl
-->

# Memory Bank: Single Source of Truth for open-webui

This Memory Bank is the central knowledge repository for the **open-webui** project. Before starting any task, you **must** review this file and follow the relevant links.
